...
function Invoice() {
  ...
  const [invoiceCompanyAddress, setInvoiceCompanyAddress] = useState(
    "Сүхбаатар, 1-р хороо, J Hotel office, 804 тоот"
  );
  const [invoiceCompanyNumber, setInvoiceCompanyNumber] = useState("86486060");
  const [invoiceCompanyEmail, setInvoiceCompanyEmail] =
    useState("info@amjilt.com");
  const [invoiceCompanyBank, setInvoiceCompanyBank] = useState("Хаан Банк");
  const [invoiceCompanyBankAccount, setInvoiceCompanyBankAccount] =
    useState("5009375511");
  const [invoiceCompanyRegister, setInvoiceCompanyRegister] =
    useState("5418097");
  ...
  function findSumUsingMap() {
    ...
    productList?.forEach((item) => {
      if (item) {
        let total =
          item.perProductPrice * item.perProductCurrencyRate * item.quantity;
        return (t = t + total);
      }
    });
    return t;
    ...
    <div className="w-full md:h-screen  gap-2 flex md:flex-row flex-col md:justify-between  md:items-center item-start p-4">
      <div className="md:w-2/6 w-full bg-white md:h-screen  overflow-auto rounded-md drop-shadow-xl p-4 flex flex-col">
        <div className="overflow-auto ">
          <div className="mt-4">
            <label className="w-full p-2 rounded-md border bg-amber-300">
              Нэхэмжлэгч
            </label>
            <input
          ...
          <div className="mt-4">
            <label className="w-full p-2 rounded-md border bg-purple-300">
              Төлөгч
            </label>
            <input
              className="w-full border p-2 rounded-md mt-2"
          ...
          <div className="mt-4">
            <label className="w-full p-2 rounded-md border bg-green-300">
              Бараа нэмэх
            </label>
            <button
              className={`border p-2 rounded-md mx-2 ${
                withTax ? "bg-green-400" : "bg-red-400"
              }`}
        ...
        >
          <div className="w-full bg-white flex justify-between items-start mt-2">
            ...
            <p className="w-full text-xs text-right">
              СЭЗ-ийн сайд, ҮСГ-ын даргын 2018 оны 12-р сарын 5-ны 347 тоот
              тушаалын хавсралт
            </p>
          </div>
          <div className="w-full bg-white flex justify-between items-start mt-2">
            <h1 className="w-full text-[20px] text-center uppercase font-bold">
              нэхэмжлэл №
            </h1>
          </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-black">
                        {withTax ? (
                          <p className="text-[12px] text-center">
                            {numberWithCommas(totalUsingMap * 0.1)}₮
                          </p>
                        ) : (
                    ...
                    <tr>
                      ...
                      <td className="border border-black">
                        {withTax ? (
                          <p className="text-[12px] text-center">
                            {numberWithCommas(
                              totalUsingMap + totalUsingMap * 0.1
                            )}
                            ₮
                          </p>
                        ) : (
          ...
          <div className="w-full flex justify-between items-start gap-2 mt-4 flex flex-row ">
            ...
            <div className="flex flex-col w-5/6 relative">
              ...
              <h1 className="text-left text-[12px] mt-2 sm:hidden">
                Дарга__________________ / ___________________ /
              </h1>
              <h1 className="text-left  text-[12px] mt-2 hidden sm:block">
                Нэхэмжлэл бичсэн_________________________ / С. Эвшинхорлоо /
              </h1>
              <h1 className="text-left  text-[12px] mt-2 sm:hidden whitespace-nowrap">
                Нэхэмжлэл бичсэн____С. Эвшинхорлоо____ /
              </h1>
              <h1 className="text-left  text-[12px] mt-2 hidden sm:block">
              ...
              <h1 className="text-left  text-[12px] mt-2 sm:hidden">
                Нэхэмжлэл хүлээн авсан____________________ /
              </h1>
            </div>
          </div>
        </div>
