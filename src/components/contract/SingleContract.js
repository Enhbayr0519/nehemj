                ...
                authorized ?
                        ...
                        <div className='w-1/6 bg-white h-full overflow-auto rounded-md drop-shadow-xl p-4 flex flex-col'>
                            <div className='mt-4'>
                                ...
                                <div className='w-full flex flex-col justify-center items-center mt-4'>
                                    <select onChange={(e) => setSelectedField(e.target.value)} className='text-[11px] border p-2 rounded-md w-5/6 '>
                                        {
                    ...
                    <div className="w-full h-[900px] flex justify-center items-center" style={{
                        ...
                        <div className='box h-48 w-96 justify-center items-center flex flex-col gap-4'>
                            <input type={"text"} value={name} onChange={(e) => setName(e.target.value)} placeholder='нэр' className={`w-5/6 p-2 rounded-md bg-gray-700/60 border-white border placeholder:text-white text-white ${nameError ? "border border-red-500" : "border border-green-500"}`} />
                            <input type={"password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder='нууц үг' className={`w-5/6 p-2 rounded-md bg-gray-700/60 border-white border placeholder:text-white text-white ${passwordError ? "border border-red-500" : "border border-green-500"}`} />
                            <button onClick={() => sendTicket()} className='w-5/6 p-2 rounded-md bg-gray-700/60 border-white border text-white hover:bg-gray-400/60 flex justify-center items-center'>
                                {
                                    loading ?
                                        <AiOutlineLoading3Quarters className='animate-spin' size={20} color="white" />
                                        :
                                        "Илгээх"
                                }
                            </button>
