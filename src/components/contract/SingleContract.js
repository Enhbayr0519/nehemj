...
function SingleContract() {
  ...
  let terms = [
    ...
    },
    {
      ...
      content: [
        {
          title: `Гэрээний баталгаат хугацаа ${converterDate(
            contractDate
          )} -наас ${converterDate(
            contractFinishDate
    ...
    },
    {
      ...
      content: [
        {
          title: `Гэрээт ажлын нийт хөлс нь ${numberWithCommas(
            contractPrice
          )}₮ / ${numToWords(contractPrice)} / төгрөг байна. `,
        },
        {
      ...
      content: [
        ...
        },
        {
          ...
          subContent: [
            {
              title:
                "Гүйцэтгэгч удаа дараа буюу хоёроос дээш удаа ажлыг чанарын шаардлага хангахгүйгээр  гүйцэтгэсэн; ",
            },
            {
              title:
                "Гүйцэтгэгчийн гүйцэтгэсэн ажил нь доголдолтой, захиалагчийн шаардлагад нийцээгүй ",
            },
          ],
        },
        {
        ...
        <div className="w-full h-screen gap-2 flex justify-between items-center p-4">
          <div className="w-1/6 bg-white h-full overflow-auto rounded-md drop-shadow-xl p-4 flex flex-col">
            <div className="mt-4">
              ...
              <div className="w-full flex flex-col justify-center items-center mt-4">
                ...
                <textarea
                  placeholder="Нэмэх заалт"
                  className="w-full rounded-md border p-2 mt-2 "
                />
                <button className="w-full rounded-md border p-2 mt-2">
                  Нэмэх
                </button>
              </div>
            </div>
          ...
          <div className="w-5/6 bg-white h-full rounded-md drop-shadow-xl flex overflow-x-scroll justify-center items-start gap-4">
            ...
            {page ? (
              <div
                ref={ref}
                className="w-[816px] bg-white h-[1104px] drop-shadow-2xl mx-auto py-[37px] px-[37px] "
              >
                ...
                <div className="w-full bg-white flex flex-row gap-2 items-start justify-between mt-4">
                  <p className="text-[12px]">
                    ...
                    Гүйцэтгэгч гэх)-ийг төлөөлж менежер С. Эвшинхорлоо нар
                    (цаашид хамтад нь Талууд гэх) Иргэний хуулийн 343-358 дугаар
                    зүйлийг үндэслэн дараахь нөхцлөөр харилцан тохиролцож энэхүү
                    гэрээг батлав.
                  </p>
                </div>
                <div className="w-full  flex justify-center items-center flex-col mt-4">
                  {terms?.slice(0, 4)?.map((item, index) => (
                    <div key={index}>
                      <h1 className="font-bold text-[14px] text-center mt-4 mb-4">
                        {item.title}{" "}
                      </h1>
                      <div>
              ...
              >
                <div className="w-full  flex justify-center items-center flex-col mt-2">
                  {terms?.slice(4, 7)?.map((item, index) => (
                    <div key={index}>
                      <h1 className="font-bold text-[14px] text-center mt-2 mb-2">
                        {item.title}{" "}
                      </h1>
                      <div>
                        {item?.content?.map((item, index) => (
                ...
                <h1 className="font-bold text-[14px] text-center mt-4 mb-4">
                  ДОЛОО. ТАЛУУДЫН АЛБАН ЁСНЫ ХАЯГ{" "}
                </h1>
                <div className="w-full flex justify-between items-start">
                  ...
                  <div className="w-full">
                    ...
                    <h1 className="text-[11px]">
                      {" "}
                      Сүхбаатар дүүрэг 1-р хороо J Tower 804 тоот Том Амжилт ХХК
                    </h1>
                    <h1 className="text-[11px]">Утас: 7711-6060</h1>
                    <h1 className="text-[11px]">
                      {" "}
                      Имэйл хаяг: info@amjilt.com
                    </h1>
                    <h1 className="text-[11px]">
